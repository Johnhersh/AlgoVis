...
export const iterativeMergeSort = (array: Array<number>, updateVisualsFunction: any) => {
    let result = array;
...
// Quicksort code
export function quickSort(array: Array<number>, start: number, end: number, updateVisualsFunction: any){
    if (start>=end) return;
...
function partition(array: Array<number>, start: number, end: number, updateVisualsFunction: any){
